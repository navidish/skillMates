...
const Join = () => {
    ...
    return (
        <section className="min-h-[537px] bg-slate-900 mt-[168px] rounded-[8px]">
            <div className="container mx-auto">
                <div className="flex flex-col gap-x-10 md:flex-row  -space-x-12
                    ...
                    <div className="-mt-[80px] max-w-[276px] md:max-w-[442px] lg:max-w-full" 
                            ...
                            data-aos-offset="100"
                            data-aos-delay="200">
                            <img src={image} alt="" className="max-h-[580px] rounded-[8px]"/>
                    </div>
                    ...
                    <div className="max-w-[450px] mr-[230px]"  
                        ...
                        <button className="button button-secondary button-lg mt-4">{btnText}</button>
